...
checkCombination MACRO i1, i2, result
    ...
    .IF( AX == 6 )
        ...
        MOV WORD PTR [SI], 7 ;clear the bomb
        ;bomb was swaped
        bomInitiate i1, i2, decision
        MOV WORD PTR [DI], 7 ;clear the bomb
...
.CODE 
    ...
    page3 PROC
        ...
        ;showing a menu to ask the game level 
        setCursor 8, 7, 0
        ;displaying the game name
        printString menuMsge
    ...
    levelTwo PROC
         ...
         PUSHA
            ...
            ;if same box swaping request again no swaping
                ...
                ;if empty then bring upper
                .IF( index1 == 0 || index1 == 1 || index1 == 3 || index1 == 5 || index1 == 6 || index1 == 27 || index1 == 21 || index1 ==48 || index1 == 47 || index1 == 42 || index1 == 43 || index1 == 45 || index2 == 0 || index2 == 1 || index2 == 3 || index2 == 5 || index2 == 6 || index2 == 27 || index2 == 21 || index2 ==48 || index2 == 47 || index2 == 42 || index2 == 43 || index2 == 45)
        ...
        PUSHA
            ...
            ;if same box swaping request again no swaping
                ...
                .ENDIF
                 ...
                 ;if empty then bring upper
                .IF( index1 == 21 || index1 == 22 || index1 == 23 || index1 == 24 || index1 == 25 || index1 == 26 || index1 == 27 || index1 ==3 || index1 == 10 || index1 == 17 || index1 == 24 || index1 == 31 || index1 == 38 || index1 == 45)

                    .IF ( index2 == 21 || index2 == 22 || index2 == 23 || index2 == 24 || index2 == 25 || index2 == 26 || index2 == 27 || index2 ==3 || index2 == 10 || index2 == 17 || index2 == 24 || index2 == 31 || index2 == 38 || index2 == 45)
                        ;for giving delay
                        MOV CX, 08H
                        MOV DX, 0FFFFH ;delay
                        MOV AH, 86H
